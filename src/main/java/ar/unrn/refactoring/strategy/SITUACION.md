...
## Situación Inicial
Un objeto `Pedido` cambia su comportamiento de cálculo de envío basándose en un código de tipo. A diferencia de la herencia (Polimorfismo), aquí queremos poder cambiar la estrategia de envío en tiempo de ejecución.
