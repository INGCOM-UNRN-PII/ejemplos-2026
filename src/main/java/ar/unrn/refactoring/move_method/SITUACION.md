...
La clase `Cuenta` tiene un método `calcularInteres()` que depende casi totalmente de los datos de la clase `TipoCuenta`.
Esto es un "Feature Envy" (envidia de características).
