...
Estos olores contribuyen a un acoplamiento excesivo entre clases o muestran qué sucede si el acoplamiento se reemplaza por una delegación excesiva.
...
- **Incomplete Library Class**: Cuando una librería no proporciona la funcionalidad necesaria y terminamos implementando métodos que deberían estar en la librería.
