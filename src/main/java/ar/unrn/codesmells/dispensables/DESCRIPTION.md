...
- **Comments**: Comentarios que explican el "qué" o "cómo" en lugar del "por qué", o que simplemente repiten lo que el código ya dice.
...
- **Speculative Generality**: Abstracciones, interfaces o parámetros creados "por si acaso" se necesitan en el futuro, pero que no tienen uso actual.
