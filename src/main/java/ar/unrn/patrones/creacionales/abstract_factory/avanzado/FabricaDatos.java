 ...
 * El paquete aplica Abstract Factory a componentes de acceso a datos para cambiar familias completas de objetos sin tocar el cliente.
 */
class SqlConexion implements Conexion {
    @Override
    public void abrir() {
        System.out.println("Abriendo conexión T-SQL...");
    }
}
 ...
 * El paquete aplica Abstract Factory a componentes de acceso a datos para cambiar familias completas de objetos sin tocar el cliente.
 */
class SqlComando implements Comando {
    @Override
    public void ejecutar(String sql) {
        System.out.println("Ejecutando T-SQL: " + sql);
    }
}
 ...
 * El paquete aplica Abstract Factory a componentes de acceso a datos para cambiar familias completas de objetos sin tocar el cliente.
 */
class MongoConexion implements Conexion {
    @Override
    public void abrir() {
        System.out.println("Conectando a cluster MongoDB...");
    }
}
 ...
 * El paquete aplica Abstract Factory a componentes de acceso a datos para cambiar familias completas de objetos sin tocar el cliente.
 */
class MongoComando implements Comando {
    @Override
    public void ejecutar(String sql) {
        System.out.println("Ejecutando Query MQL: " + sql);
    }
}
