...
class SillaModerna implements Silla {
    ...
    public void sentarse() {
        System.out.println("Sentado en silla minimalista moderna.");
    }
}
...
class SofaModerno implements Sofa {
    ...
    public void acostarse() {
        System.out.println("Acostado en sofá moderno gris.");
    }
}
...
class SillaVictoriana implements Silla {
    @Override
    public void sentarse() {
        System.out.println("Sentado en silla victoriana ornamentada.");
    }
}
...
class SofaVictoriano implements Sofa {
    @Override
    public void acostarse() {
        System.out.println("Acostado en sofá victoriano de terciopelo.");
    }
}
